        ...
        <div>
          <div className="mt-4">
            ...
            <Input
              ...
              onChange={(e) => setAnthropicModel(e.target.value.trim() || null)}
          ...
          <div className="mt-4">
            ...
            <Input
              ...
              onChange={(e) => setAnthropicApiKey(e.target.value.trim() || null)}
              placeholder="sk-ant-..."
              helperText="Pasting will be enough. No save button required."
            />
          </div>
        ...
        <div>
          <div className="mt-4">
            ...
            <Input
              type="text"
              value={falModel ?? ''}
              onChange={(e) => setFalModel(e.target.value.trim() || null)}
              placeholder="fal-ai/llama-3-1-8b-instruct"
              helperText="Pasting will be enough. No save button required."
            />
          </div>
          <div className="mt-4">
            ...
            <Input
              type="password"
              value={falApiKey ?? ''}
              onChange={(e) => setFalApiKey(e.target.value.trim() || null)}
              placeholder="fal_..."
              helperText="Pasting will be enough. No save button required."
            />
          </div>
